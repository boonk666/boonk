...
export default function Index() {
  ...
  return (
    <SafeAreaView style={{ minHeight: '100%', justifyContent: 'center',  backgroundColor: 'white' }}>
      ...
      <TextInput value={username} onChangeText={setusername} placeholder='Username' placeholderTextColor={'grey'} style={{ borderWidth: 1, borderRadius: 16, borderColor: '#ddd', paddingVertical: 8, paddingHorizontal: 16 }} />
      <TextInput value={password} onChangeText={setpassword} placeholder='Password' placeholderTextColor={'grey'} style={{ borderWidth: 1, borderRadius: 16, borderColor: '#ddd', paddingVertical: 8, paddingHorizontal: 16, marginBottom: 24 }} />
